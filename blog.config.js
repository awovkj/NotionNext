...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sanye.me', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/awovkj/NotionNext', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // START ************网站字体*****************
  // ['font-serif'font-sans] 两种可选，分别是衬线和无衬线: 参考 https://www.jianshu.com/p/55e410bd2115sd
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'too.510517.xyz', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-MBMSS6YDXP', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_GOOGLE_SITE_VERIFICATION || 'G-MBMSS6YDXP', // Remove the value or replace it with your own google site verification code

  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || '', // Remove the value or replace it with your own google site verification code

  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'ps5sxzw7ba', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '𝓢𝓪𝓷𝔂𝓮 𝓑𝓵𝓸𝓰', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '𝓢𝓪𝓷𝔂𝓮 𝓑𝓵𝓸𝓰', // 站点描述，被notion中的页面描述覆盖
