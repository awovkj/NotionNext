...
export default function CategoryBar(props) {
  ...
  return (
    <div
      id='category-bar'
      className={`wow fadeInUp flex flex-nowrap justify-between items-center h-12 mb-4 space-x-2 w-full bg-white dark:bg-[#18171d]  
            ${border ? 'border hover:border dark:border-gray-800 hover:border-indigo-600 dark:hover:border-yellow-600 ' : ''}  py-2 px-2 rounded-xl transition-colors duration-200`}>
      <div
